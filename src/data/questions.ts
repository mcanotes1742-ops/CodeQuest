  ...
  // ==================== SET 1 ====================
  {
    ...
    levels: {
      1: {
        type: "riddle",
        question:
    "I hold many values in one variable, and each value can be accessed using a position number. What am I?",
  answer: "array",
      },
      2: {
        type: "output",
  ...
  // ==================== SET 2 ====================
  {
    ...
    levels: {
      1: {
        type: "riddle",
        question:
    "I am used to repeat a block of code while a condition remains true. What am I?",
  answer: "loop",
      },
      2: {
        type: "output",
  ...
  // ==================== SET 3 ====================
  {
    ...
    levels: {
      1: {
        type: "riddle",
        question:
    "I store data as key-value pairs, like a real-world dictionary stores words and meanings. What am I?",
  answer: "dictionary",
      },
      2: {
        type: "output",
  ...
  // ==================== SET 4 ====================
  {
    ...
    levels: {
      1: {
        type: "riddle",
        question:
    "I am a reusable block of code that performs a specific task. You can call me whenever you need me. What am I?",
  answer: "function",
      },
      2: {
        type: "output",
...
// ==================== SET 6 ====================
{
  ...
  levels: {
    1: {
      type: "riddle",
      question:
    "I use a first-in, first-out rule. The first item added is the first item removed. What data structure am I?",
  answer: "queue",
    },
